      ...
      <div className='w-full h-full flex flex-col justify-center items-center background py-12 px-6'>
        <div className='w-full flex justify-center'>
          <div className='w-full justify-start absolute ps-24'>
            <button onClick={Clearform} className='text-white font-semibold absolute button-clear rounded-lg h-12 w-32'>Clear</button>
          </div>
        ...
        <form onSubmit={handleSubmit(generate)} className="w-full h-full flex flex-col justify-start items-center">
          ...
          <Education data={data} register={register} inputStatus={inputStatus} statusChange={statusChange} errors={errors}/>
                ...
                <div className='w-full flex h-16 gap-x-2 items-center'>
                  <div className='w-1/2 flex flex-col h-full'>
                    <textarea
                      ...
                      className='title border-4 border-gray-400 rounded-xl w-full ps-4 text-2xl'
