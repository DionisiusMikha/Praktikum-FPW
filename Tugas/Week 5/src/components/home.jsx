              ...
              <div className="new-relase">
                ...
                <div className="overlap" >
                  ...
                  <div className="text-wrapper-6">
                    {wishlist.includes(newReleaseData[idNewRelease].dealID) ? (
                      <button onClick={() => dispatch(removeFromWishlist(newReleaseData[idNewRelease].dealID))} className="text-red-400 text-xl hover:underline">- Remove From Wishlist</button>
                    ) : (
                      <button onClick={() => dispatch(addToWishlist(newReleaseData[idNewRelease].dealID))} className="text-blue-400 text-xl hover:underline">+ Add to Wishlist</button>
                    )}
                    </div>
                    </div>
                </div>
